...
const _hoisted_34 = { class: "mlk-poster" };
const _hoisted_35 = {
  key: 1,
  class: "mlk-poster-fallback"
};
const _hoisted_36 = { class: "mlk-media-body" };
const _hoisted_37 = { class: "mlk-media-head" };
const _hoisted_38 = { class: "mlk-media-title" };
const _hoisted_39 = { class: "mlk-media-meta" };
const _hoisted_40 = { class: "mlk-media-note" };
const _hoisted_41 = { class: "mlk-chip-row mlk-chip-row--compact" };
const _hoisted_42 = { class: "mlk-media-facts" };
const _hoisted_43 = { class: "mlk-media-fact mlk-media-fact--volume" };
const _hoisted_44 = { class: "mlk-section" };
const _hoisted_45 = { class: "mlk-plan-bar-title" };
const _hoisted_46 = { class: "text-body-2 text-medium-emphasis" };
const _hoisted_47 = { class: "mlk-plan-summary" };
const _hoisted_48 = { class: "mlk-plan-main" };
const _hoisted_49 = { class: "mlk-plan-bar-title" };
const _hoisted_50 = { class: "text-subtitle-1 font-weight-medium" };
const _hoisted_51 = { class: "text-caption text-medium-emphasis" };
const _hoisted_52 = { class: "text-body-2 text-medium-emphasis" };
const _hoisted_53 = { class: "mlk-chip-row" };
const _hoisted_54 = { class: "mlk-plan-actions" };
const _hoisted_55 = { class: "mlk-plan-detail" };
const _hoisted_56 = { class: "mlk-table-actions" };
const _hoisted_57 = { class: "mlk-section" };
const _hoisted_58 = {
  key: 0,
  class: "text-error"
};
const _hoisted_59 = { class: "mlk-table-actions" };
const _hoisted_60 = { class: "mlk-section mlk-settings" };
const _hoisted_61 = { class: "mlk-settings-group" };
const _hoisted_62 = { class: "mlk-switch-grid" };
const _hoisted_63 = { class: "mlk-form-grid" };
const _hoisted_64 = { class: "mlk-settings-group" };
const _hoisted_65 = { class: "mlk-form-grid" };
const _hoisted_66 = { class: "mlk-settings-group" };
const _hoisted_67 = { class: "mlk-section-header" };
const _hoisted_68 = { class: "mlk-settings-group" };
const _hoisted_69 = { class: "mlk-section-header" };
const _hoisted_70 = { class: "mlk-settings-group" };
const _hoisted_71 = { class: "mlk-switch-grid" };
const _hoisted_72 = { class: "mlk-settings-group" };
const _hoisted_73 = { class: "mlk-section-header" };
const _hoisted_74 = { class: "mlk-section-actions" };
const _hoisted_75 = { class: "mlk-rule-title" };
const _hoisted_76 = { class: "mlk-rule-grid" };
const _hoisted_77 = { class: "mlk-settings-actions" };
const _hoisted_78 = { class: "mlk-detail-layout" };
const _hoisted_79 = { class: "mlk-detail-aside" };
const _hoisted_80 = { class: "mlk-detail-poster" };
const _hoisted_81 = {
  key: 1,
  class: "mlk-poster-fallback"
};
const _hoisted_82 = { class: "mlk-detail-aside-info" };
const _hoisted_83 = { class: "mlk-detail-aside-row" };
...
const _hoisted_88 = { class: "mlk-detail-content" };
const _hoisted_89 = { class: "mlk-detail-head" };
const _hoisted_90 = { class: "text-h6 font-weight-bold" };
const _hoisted_91 = { class: "text-body-2 text-medium-emphasis" };
const _hoisted_92 = { class: "mlk-chip-row" };
const _hoisted_93 = { class: "mlk-overview" };
const _hoisted_94 = { class: "mlk-detail-grid" };
const _hoisted_95 = { class: "text-caption text-medium-emphasis" };
const _hoisted_96 = { class: "mlk-detail-wide" };
const _hoisted_97 = {
  key: 0,
...
const _hoisted_99 = { class: "mlk-chip-row" };
const _hoisted_100 = { class: "mlk-detail-actions" };
const _hoisted_101 = { class: "mlk-plan-target-title mb-3" };
const _hoisted_102 = { class: "text-subtitle-2" };
const _hoisted_103 = {
  key: 0,
  class: "text-body-2 text-medium-emphasis mb-3"
};
const _hoisted_104 = { class: "mb-5" };
const _hoisted_105 = { class: "mlk-target-head" };
const _hoisted_106 = { class: "text-body-2 font-weight-medium" };
const _hoisted_107 = {
  key: 0,
...
const _hoisted_116 = { class: "mlk-target-head" };
const _hoisted_117 = {
  key: 0,
  class: "text-caption text-medium-emphasis"
};
...
const _hoisted_123 = { class: "text-body-2" };
const _hoisted_124 = { class: "text-caption text-medium-emphasis" };
const _hoisted_125 = { class: "text-caption text-medium-emphasis" };
const _hoisted_126 = {
  key: 4,
  class: "mt-5"
};
const _hoisted_127 = { class: "mlk-target-head" };
const _hoisted_128 = { class: "text-body-2" };
const _hoisted_129 = { class: "text-body-2" };
const _hoisted_130 = { class: "text-caption text-medium-emphasis mt-1" };
const _hoisted_131 = { class: "mlk-detail-summary mb-4" };
const _hoisted_132 = { class: "text-body-2 text-medium-emphasis mb-4" };
const _hoisted_133 = {
  key: 0,
  class: "mb-4"
};
const _hoisted_134 = { class: "mlk-chip-row" };
const _hoisted_135 = {
  key: 0,
  class: "text-caption text-medium-emphasis"
};
...
const _hoisted_137 = { class: "text-body-2" };
...
return (_ctx, _cache) => {
  ...
  return (_openBlock(), _createElementBlock("div", _hoisted_1, [
                ...
                _createElementVNode("div", _hoisted_18, [
                  _createElementVNode("div", _hoisted_19, [
                    ...
                    _createVNode(_component_VSelect, {
                      ...
                      "onUpdate:modelValue": _cache[4] || (_cache[4] = $event => ((typeFilter).value = $event)),
                      label: "媒体类型",
                      items: ['全部', '电影', '剧集'],
                      density: "comfortable",
                      "hide-details": ""
                    ...
                    _createVNode(_component_VSelect, {
                      ...
                      "onUpdate:modelValue": _cache[5] || (_cache[5] = $event => ((mediaSort).value = $event)),
                      label: "排序规则",
                      items: sortOptions,
                      density: "comfortable",
                      "hide-details": ""
                    ...
                    _createVNode(_component_VBtn, {
                      ...
                      variant: "tonal",
                      onClick: _cache[7] || (_cache[7] = $event => (sortDesc.value = !sortDesc.value))
                    }, {
                      default: _withCtx(() => [
                            ...
                            default: _withCtx(() => [
                              ...
                              _createElementVNode("div", _hoisted_36, [
                                _createElementVNode("div", _hoisted_37, [
                                  ...
                                  _createElementVNode("div", _hoisted_39, _toDisplayString(item.reason), 1)
                                ]),
                                _createElementVNode("div", _hoisted_40, _toDisplayString(item.message), 1),
                    ...
                    default: _withCtx(() => [
                      _createElementVNode("div", null, [
                        _createElementVNode("div", _hoisted_45, [
                          _cache[47] || (_cache[47] = _createElementVNode("span", { class: "text-subtitle-1 font-weight-medium" }, "当前选择", -1)),
                          _createVNode(_component_VTooltip, {
                            ...
                            activator: _withCtx(({ props: tooltipProps }) => [
                              _createVNode(_component_VBtn, _mergeProps(tooltipProps, {
                                ...
                                onClick: _cache[8] || (_cache[8] = $event => (selectedPlanExpanded.value = !selectedPlanExpanded.value))
                              }), null, 16, ["icon", "disabled"])
                            ]),
                            _: 1
                          }, 8, ["text"])
                        ]),
                        _createElementVNode("div", _hoisted_46, " 已选择 " + _toDisplayString(selectedMedia.value.length) + " 项，当前 Emby 可见体积 " + _toDisplayString(_unref(formatBytes)(selectedSize.value)), 1)
                      ]),
                      _createVNode(_component_VSpacer),
                      _createVNode(_component_VBtn, {
                        color: "primary",
                  ...
                  _createVNode(_component_VExpandTransition, null, {
                    default: _withCtx(() => [
                      _withDirectives(_createVNode(_component_VSheet, {
                        ...
                        default: _withCtx(() => [
                          _cache[50] || (_cache[50] = _createElementVNode("div", { class: "mlk-section-header" }, [
                            _createElementVNode("div", null, [
                          ...
                          _createElementVNode("div", _hoisted_47, [
                            _createElementVNode("div", _hoisted_48, [
                              _createElementVNode("div", _hoisted_49, [
                                _createElementVNode("span", _hoisted_50, "批次 " + _toDisplayString(pendingPlan.value.batch_id || pendingPlan.value.id), 1),
                                _createVNode(_component_VTooltip, {
                                  ...
                                  activator: _withCtx(({ props: tooltipProps }) => [
                                    _createVNode(_component_VBtn, _mergeProps(tooltipProps, {
                                      ...
                                      variant: "text",
                                      size: "small",
                                      onClick: _cache[9] || (_cache[9] = $event => (planExpanded.value = !planExpanded.value))
                                    }), null, 16, ["icon"])
                                  ]),
                                  _: 1
                                }, 8, ["text"])
                              ]),
                              _createElementVNode("div", _hoisted_51, _toDisplayString(pendingPlan.value.source_label || '手动选择') + " · " + _toDisplayString(pendingPlan.value.created_at), 1),
                              _createElementVNode("div", _hoisted_52, _toDisplayString(pendingPlan.value.message), 1),
                ...
                { title: '详情', key: 'actions', width: 90, sortable: false, align: 'center' },
                    ...
                    "item.seed_tasks": _withCtx(({ item }) => [
                      ...
                      (cleanupRecordStats(item).failedSeedTasks)
                        ? (_openBlock(), _createElementBlock("span", _hoisted_58, "/" + _toDisplayString(cleanupRecordStats(item).failedSeedTasks) + " 失败", 1))
                        : _createCommentVNode("", true)
                    ]),
                    "item.actions": _withCtx(({ item }) => [
              ...
              default: _withCtx(() => [
                _createElementVNode("div", _hoisted_60, [
                  _createElementVNode("div", _hoisted_61, [
                    ...
                    _createElementVNode("div", _hoisted_62, [
                      ...
                      _createVNode(_component_VSwitch, {
                        ...
                        "onUpdate:modelValue": _cache[11] || (_cache[11] = $event => ((configDraft.value.show_sidebar_nav) = $event)),
                        color: "primary",
                        inset: "",
                        label: "显示侧边栏入口"
                      }, null, 8, ["modelValue"]),
                      _createVNode(_component_VSwitch, {
                        ...
                        "onUpdate:modelValue": _cache[12] || (_cache[12] = $event => ((configDraft.value.notify_enabled) = $event)),
                        color: "primary",
                        inset: "",
                        label: "启用通知"
                      }, null, 8, ["modelValue"]),
                      _createVNode(_component_VSwitch, {
                        ...
                        "onUpdate:modelValue": _cache[13] || (_cache[13] = $event => ((configDraft.value.disk_warning_enabled) = $event)),
                        color: "warning",
                        inset: "",
                        label: "启用磁盘容量告警"
                      }, null, 8, ["modelValue"])
                    ...
                    _createElementVNode("div", _hoisted_63, [
                      ...
                      _createVNode(_component_VSelect, {
                        ...
                        "onUpdate:modelValue": _cache[15] || (_cache[15] = $event => ((configDraft.value.downloaders) = $event)),
                        label: "下载器",
                  ...
                  _createElementVNode("div", _hoisted_64, [
                    _cache[56] || (_cache[56] = _createElementVNode("div", { class: "text-subtitle-1 font-weight-medium" }, "扫描和清理计划", -1)),
                    _createElementVNode("div", _hoisted_65, [
                      ...
                      _createVNode(_component_VTextField, {
                        ...
                        "onUpdate:modelValue": _cache[17] || (_cache[17] = $event => ((configDraft.value.disk_warning_free_gb) = $event)),
                        modelModifiers: { number: true },
                        type: "number",
                        min: "0",
                        label: "剩余容量低于 GB"
                      ...
                      _createVNode(_component_VTextField, {
                        ...
                        "onUpdate:modelValue": _cache[18] || (_cache[18] = $event => ((configDraft.value.disk_warning_free_percent) = $event)),
                        modelModifiers: { number: true },
                        type: "number",
                        min: "0",
                        label: "剩余比例低于 %"
                  ...
                  _createElementVNode("div", _hoisted_70, [
                    _cache[64] || (_cache[64] = _createElementVNode("div", { class: "text-subtitle-1 font-weight-medium" }, "删除行为", -1)),
                    _createElementVNode("div", _hoisted_71, [
                      ...
                      _createVNode(_component_VSwitch, {
                        ...
                        "onUpdate:modelValue": _cache[19] || (_cache[19] = $event => ((configDraft.value.default_delete_source) = $event)),
                        color: "error",
                        inset: "",
                        label: "默认同时删除源文件"
                      }, null, 8, ["modelValue"]),
                      _createVNode(_component_VSwitch, {
                        ...
                        "onUpdate:modelValue": _cache[20] || (_cache[20] = $event => ((configDraft.value.delete_seed_tasks) = $event)),
                        color: "warning",
                        inset: "",
                        label: "删除资源时同步删除保种任务"
                      }, null, 8, ["modelValue"])
                  ...
                  _createElementVNode("div", _hoisted_72, [
                    _createElementVNode("div", _hoisted_73, [
                      ...
                      _createElementVNode("div", _hoisted_74, [
                        _createVNode(_component_VBtn, {
                          ...
                          onClick: _cache[21] || (_cache[21] = $event => (syncLibraries()))
                        }, {
                    ...
                    _createVNode(_component_VSelect, {
                      ...
                      "onUpdate:modelValue": _cache[22] || (_cache[22] = $event => ((configDraft.value.cleanup_libraries) = $event)),
                      label: "清理媒体库",
                    ...
                    (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(configDraft.value.cleanup_rules, (rule, index) => {
                      return (_openBlock(), _createBlock(_component_VSheet, {
                        ...
                        default: _withCtx(() => [
                          _createElementVNode("div", _hoisted_75, "组合 " + _toDisplayString(index + 1), 1),
                    ...
                    _cache[68] || (_cache[68] = _createElementVNode("div", { class: "text-caption text-medium-emphasis" }, "数字条件填 0 表示不启用；每条组合至少启用一个条件才会生效。", -1))
                  ]),
    ...
    _createVNode(_component_VDialog, {
      ...
      "onUpdate:modelValue": _cache[27] || (_cache[27] = $event => ((detailDialog).value = $event)),
      "max-width": "920"
    }, {
      default: _withCtx(() => [
                ...
                _createElementVNode("div", _hoisted_78, [
                  _createElementVNode("div", _hoisted_79, [
                    ...
                    _createElementVNode("div", _hoisted_82, [
                      _cache[75] || (_cache[75] = _createElementVNode("div", { class: "text-subtitle-2 font-weight-medium" }, "媒体摘要", -1)),
                      _createElementVNode("div", _hoisted_83, [
                        _cache[71] || (_cache[71] = _createElementVNode("span", null, "观看状态", -1)),
                        _createElementVNode("strong", null, _toDisplayString(watchStateText(selectedMediaDetail.value)), 1)
                      ]),
                      _createElementVNode("div", _hoisted_84, [
                        _cache[72] || (_cache[72] = _createElementVNode("span", null, "媒体大小", -1)),
                        _createElementVNode("strong", null, _toDisplayString(_unref(formatBytes)(selectedMediaDetail.value.size)), 1)
                      ]),
                      _createElementVNode("div", _hoisted_85, [
                        _cache[73] || (_cache[73] = _createElementVNode("span", null, "所在盘", -1)),
                        _createElementVNode("strong", null, _toDisplayString(selectedMediaDetail.value.volume_name || '-'), 1)
                      ]),
                      _createElementVNode("div", _hoisted_86, [
                        _cache[74] || (_cache[74] = _createElementVNode("span", null, "卷剩余", -1)),
                  ...
                  _createElementVNode("div", _hoisted_88, [
                    _createElementVNode("div", _hoisted_89, [
                      _createElementVNode("div", null, [
                        _createElementVNode("div", _hoisted_90, _toDisplayString(selectedMediaDetail.value.title), 1),
                        _createElementVNode("div", _hoisted_91, _toDisplayString(selectedMediaDetail.value.year || '未知年份') + " · " + _toDisplayString(selectedMediaDetail.value.type_label) + " · " + _toDisplayString(selectedMediaDetail.value.library || selectedMediaDetail.value.server), 1)
                      ]),
                      _createVNode(_component_VBtn, {
                        icon: "mdi-close",
                        variant: "text",
                    ...
                    _createElementVNode("p", _hoisted_93, _toDisplayString(selectedMediaDetail.value.overview || '暂无简介。'), 1),
                    _createElementVNode("div", _hoisted_94, [
                      (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(selectedDetailInfoRows.value, (row) => {
                        return (_openBlock(), _createElementBlock("div", {
                          key: row.label
                        }, [
                          _createElementVNode("div", _hoisted_95, _toDisplayString(row.label), 1),
                          _createElementVNode("div", null, _toDisplayString(row.value), 1)
                        ]))
                      }), 128)),
                      _createElementVNode("div", _hoisted_96, [
                        _cache[76] || (_cache[76] = _createElementVNode("div", { class: "text-caption text-medium-emphasis" }, "路径", -1)),
                      ...
                      (selectedMediaDetail.value.emby_path_preview)
                        ? (_openBlock(), _createElementBlock("div", _hoisted_97, [
                            _cache[77] || (_cache[77] = _createElementVNode("div", { class: "text-caption text-medium-emphasis" }, "Emby 原路径", -1)),
                      ...
                      (selectedMediaDetail.value.genres?.length)
                        ? (_openBlock(), _createElementBlock("div", _hoisted_98, [
                            _cache[78] || (_cache[78] = _createElementVNode("div", { class: "text-caption text-medium-emphasis" }, "类型", -1)),
                    ...
                    _createElementVNode("div", _hoisted_100, [
                      _createVNode(_component_VBtn, {
                        ...
                        onClick: _cache[25] || (_cache[25] = $event => (toggleSelected(selectedMediaDetail.value)))
                      }, {
                        default: _withCtx(() => [
                      ...
                      _createVNode(_component_VBtn, {
                        ...
                        onClick: _cache[26] || (_cache[26] = $event => (createSinglePlan(selectedMediaDetail.value)))
                      }, {
    ...
    _createVNode(_component_VDialog, {
      ...
      "onUpdate:modelValue": _cache[29] || (_cache[29] = $event => ((planTargetDialog).value = $event)),
      "max-width": "820"
    }, {
      default: _withCtx(() => [
              ...
              default: _withCtx(() => [
                ...
                _createVNode(_component_VCardText, null, {
                  default: _withCtx(() => [
                    _createElementVNode("div", _hoisted_101, [
                      _createElementVNode("div", _hoisted_102, _toDisplayString(selectedPlanItem.value.title), 1),
                      _createVNode(_component_VChip, {
                    ...
                    (selectedPlanItem.value.message)
                      ? (_openBlock(), _createElementBlock("div", _hoisted_103, _toDisplayString(selectedPlanItem.value.message), 1))
                      : _createCommentVNode("", true),
                    ...
                    _createElementVNode("div", _hoisted_104, [
                      _cache[85] || (_cache[85] = _createElementVNode("div", { class: "text-subtitle-2 mb-2" }, "下载器任务", -1)),
                            ...
                            default: _withCtx(() => [
                              (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(selectedMatchedDownloadTasks.value, (task) => {
                                return (_openBlock(), _createElementBlock("div", {
                                  ...
                                  _createElementVNode("div", _hoisted_106, _toDisplayString(downloadTaskTitle(task)), 1),
                                  (downloadTaskHint(task))
                                    ? (_openBlock(), _createElementBlock("div", _hoisted_107, _toDisplayString(downloadTaskHint(task)), 1))
                                    : _createCommentVNode("", true),
                                  (task.save_path)
                                    ? (_openBlock(), _createElementBlock("div", _hoisted_108, "保存目录：" + _toDisplayString(task.save_path), 1))
                                    : _createCommentVNode("", true),
                                  (task.content_path && task.content_path !== task.save_path)
                                    ? (_openBlock(), _createElementBlock("div", _hoisted_109, "内容路径：" + _toDisplayString(task.content_path), 1))
                                    : _createCommentVNode("", true),
                                  (task.original_downloader && task.original_downloader !== downloadTaskName(task))
                                    ? (_openBlock(), _createElementBlock("div", _hoisted_110, "原下载器：" + _toDisplayString(task.original_downloader), 1))
                                    : _createCommentVNode("", true)
                                ]))
                              }), 128))
                            ]),
                      ...
                      (selectedHistoryHashSummary.value)
                        ? (_openBlock(), _createBlock(_component_VSheet, {
                            ...
                            default: _withCtx(() => [
                              ...
                              _cache[82] || (_cache[82] = _createElementVNode("div", { class: "text-body-2 font-weight-medium" }, "未读取到配置下载器实时任务信息", -1)),
                              _cache[83] || (_cache[83] = _createElementVNode("div", { class: "text-caption text-medium-emphasis" }, " 当前批次只保存历史 Hash，未在配置下载器实时任务中定位到任务；执行清理时仍会按 Hash 到配置下载器尝试删除。 ", -1)),
                              _createElementVNode("div", _hoisted_112, "来源：" + _toDisplayString(summaryEntries(selectedHistoryHashSummary.value.sources)), 1),
                              _createElementVNode("div", _hoisted_113, "候选下载器：" + _toDisplayString(summaryEntries(selectedHistoryHashSummary.value.downloaders)), 1),
                              (selectedHistoryHashSummary.value.titles.length)
                                ? (_openBlock(), _createElementBlock("div", _hoisted_114, " 历史记录：" + _toDisplayString(selectedHistoryHashSummary.value.titles.slice(0, 3).join(' / ')) + _toDisplayString(selectedHistoryHashSummary.value.titles.length > 3 ? ` 等 ${selectedHistoryHashSummary.value.titles.length} 条` : ''), 1))
                                : _createCommentVNode("", true)
                            ]),
                            _: 1
                          }))
                            ...
                            return (_openBlock(), _createBlock(_component_VSheet, {
                              ...
                              default: _withCtx(() => [
                                ...
                                (target.kind === 'src' && target.filename)
                                  ? (_openBlock(), _createElementBlock("div", _hoisted_117, "源文件名"))
                                  : _createCommentVNode("", true),
                                (target.kind === 'src' && target.filename)
                                  ? (_openBlock(), _createElementBlock("div", _hoisted_118, _toDisplayString(target.filename), 1))
                                  : _createCommentVNode("", true),
                                _cache[87] || (_cache[87] = _createElementVNode("div", { class: "text-caption text-medium-emphasis mt-1" }, "文件路径", -1)),
                                _createElementVNode("div", _hoisted_119, _toDisplayString(target.path || target.path_preview), 1),
                                (target.directory_mapping)
                                  ? (_openBlock(), _createElementBlock("div", _hoisted_120, " 目录配置：" + _toDisplayString(target.directory_mapping.name || '未命名目录配置') + "；整理方式：" + _toDisplayString(target.directory_mapping.transfer_type || '未知'), 1))
                                  : _createCommentVNode("", true)
                              ]),
                              _: 2
                            }, 1024))
                    ...
                    (selectedPlanItem.value.seed_candidates?.length)
                      ? (_openBlock(), _createElementBlock("div", _hoisted_121, [
                          _cache[90] || (_cache[90] = _createElementVNode("div", { class: "text-subtitle-2 mb-2" }, "保种排查候选", -1)),
                          _createVNode(_component_VAlert, {
                            type: "warning",
                            variant: "tonal",
                            density: "comfortable",
                          ...
                          (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(selectedPlanItem.value.seed_candidates, (candidate) => {
                            return (_openBlock(), _createBlock(_component_VSheet, {
                              ...
                              default: _withCtx(() => [
                                ...
                                _createElementVNode("div", _hoisted_123, _toDisplayString(candidate.downloader_path), 1),
                                _createElementVNode("div", _hoisted_124, "MP 资源路径：" + _toDisplayString(candidate.source_path), 1),
                                _createElementVNode("div", _hoisted_125, _toDisplayString(candidate.reason), 1)
                              ]),
                              _: 2
                            }, 1024))
                          }), 128))
                    ...
                    (selectedPlanItem.value.ai_resource_candidates?.length)
                      ? (_openBlock(), _createElementBlock("div", _hoisted_126, [
                          _cache[95] || (_cache[95] = _createElementVNode("div", { class: "text-subtitle-2 mb-2" }, "AI识别候选源文件", -1)),
                          _createVNode(_component_VAlert, {
                            type: "info",
                            variant: "tonal",
                            density: "comfortable",
                          ...
                          (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(selectedPlanItem.value.ai_resource_candidates, (candidate) => {
                            return (_openBlock(), _createBlock(_component_VSheet, {
                              ...
                              default: _withCtx(() => [
                                ...
                                _cache[93] || (_cache[93] = _createElementVNode("div", { class: "text-caption text-medium-emphasis" }, "源文件名", -1)),
                                _createElementVNode("div", _hoisted_128, _toDisplayString(candidate.filename || '-'), 1),
                                _cache[94] || (_cache[94] = _createElementVNode("div", { class: "text-caption text-medium-emphasis mt-1" }, "路径", -1)),
                                _createElementVNode("div", _hoisted_129, _toDisplayString(candidate.source_path), 1),
                                _createElementVNode("div", _hoisted_130, _toDisplayString(candidate.reason), 1)
                              ]),
                              _: 2
                            }, 1024))
                          }), 128))
                ...
                _createVNode(_component_VCardActions, null, {
                  default: _withCtx(() => [
                    ...
                    _createVNode(_component_VBtn, {
                      variant: "text",
                      onClick: _cache[28] || (_cache[28] = $event => (planTargetDialog.value = false))
                    }, {
    ...
    _createVNode(_component_VDialog, {
      ...
      "onUpdate:modelValue": _cache[31] || (_cache[31] = $event => ((historyDetailDialog).value = $event)),
      "max-width": "980"
    }, {
      default: _withCtx(() => [
        (selectedHistoryItem.value)
          ? (_openBlock(), _createBlock(_component_VCard, { key: 0 }, {
              default: _withCtx(() => [
                ...
                _createVNode(_component_VCardText, null, {
                  default: _withCtx(() => [
                    ...
                    _createElementVNode("div", _hoisted_132, _toDisplayString(selectedHistoryItem.value.message), 1),
                    (selectedHistoryItem.value.items?.length)
                      ? (_openBlock(), _createElementBlock("div", _hoisted_133, [
                          _cache[98] || (_cache[98] = _createElementVNode("div", { class: "text-subtitle-2 mb-2" }, "本次媒体", -1)),
                      ...
                      : _createCommentVNode("", true),
                    _cache[100] || (_cache[100] = _createElementVNode("div", { class: "text-subtitle-2 mb-2" }, "删除文件", -1)),
                    _createVNode(_component_VDataTable, {
                      headers: [
              ...
              { title: '路径', key: 'path_preview' },
                    ...
                    _cache[101] || (_cache[101] = _createElementVNode("div", { class: "text-subtitle-2 mt-5 mb-2" }, "保种任务", -1)),
                    _createVNode(_component_VDataTable, {
                      headers: [
              ...
              { title: '结果', key: 'result', width: 110 },
                      ...
                      "item.downloader": _withCtx(({ item }) => [
                        ...
                        (item.original_downloader && item.original_downloader !== item.downloader)
                          ? (_openBlock(), _createElementBlock("div", _hoisted_135, " 原 " + _toDisplayString(item.original_downloader), 1))
                          : _createCommentVNode("", true)
                      ]),
                    ...
                    (selectedHistoryItem.value.failed_targets?.length)
                      ? (_openBlock(), _createElementBlock("div", _hoisted_136, [
                          _cache[99] || (_cache[99] = _createElementVNode("div", { class: "text-subtitle-2 mb-2" }, "失败项", -1)),
                          _createVNode(_component_VDataTable, {
                            headers: [
                { title: '类型', key: 'kind_label', width: 120 },
                { title: '路径', key: 'path_preview' },
                ...
                _createVNode(_component_VCardActions, null, {
                  default: _withCtx(() => [
                    ...
                    _createVNode(_component_VBtn, {
                      variant: "text",
                      onClick: _cache[30] || (_cache[30] = $event => (historyDetailDialog.value = false))
                    }, {
    ...
    _createVNode(_component_VDialog, {
      ...
      "onUpdate:modelValue": _cache[34] || (_cache[34] = $event => ((executeDialog).value = $event)),
      "max-width": "640"
    }, {
      default: _withCtx(() => [
        _createVNode(_component_VCard, null, {
          default: _withCtx(() => [
            ...
            _createVNode(_component_VCardText, null, {
              default: _withCtx(() => [
                _createElementVNode("div", _hoisted_137, " 本次计划将删除 " + _toDisplayString(pendingPlan.value?.ready_count || 0) + " 个可执行媒体条目关联文件，预计释放 " + _toDisplayString(_unref(formatBytes)(pendingPlan.value?.estimated_reclaim_size)) + "。执行成功后会删除对应整理记录。 ", 1),
                ...
                _createVNode(_component_VCheckbox, {
                  ...
                  "onUpdate:modelValue": _cache[32] || (_cache[32] = $event => ((executeConfirmed).value = $event)),
                  color: "error",
            ...
            _createVNode(_component_VCardActions, null, {
              default: _withCtx(() => [
                ...
                _createVNode(_component_VBtn, {
                  variant: "text",
                  onClick: _cache[33] || (_cache[33] = $event => (executeDialog.value = false))
                }, {
    ...
    _createVNode(_component_VDialog, {
      ...
      "onUpdate:modelValue": _cache[37] || (_cache[37] = $event => ((deletePlanDialog).value = $event)),
      "max-width": "560"
    }, {
      default: _withCtx(() => [
        _createVNode(_component_VCard, null, {
          default: _withCtx(() => [
            ...
            _createVNode(_component_VCardText, null, {
              default: _withCtx(() => [
                _createElementVNode("div", _hoisted_138, " 将删除批次 " + _toDisplayString(pendingPlan.value?.batch_id || pendingPlan.value?.id) + " 的待处理记录，不会删除媒体文件、源文件或整理记录。 ", 1),
                _createVNode(_component_VCheckbox, {
                  modelValue: deletePlanConfirmed.value,
                  "onUpdate:modelValue": _cache[35] || (_cache[35] = $event => ((deletePlanConfirmed).value = $event)),
                  color: "error",
                  label: "我确认只删除当前批次记录",
                  "hide-details": "",
                  class: "mt-4"
            ...
            _createVNode(_component_VCardActions, null, {
              default: _withCtx(() => [
                ...
                _createVNode(_component_VBtn, {
                  variant: "text",
                  onClick: _cache[36] || (_cache[36] = $event => (deletePlanDialog.value = false))
                }, {
    ...
    _createVNode(_component_VSnackbar, {
      ...
      "onUpdate:modelValue": _cache[38] || (_cache[38] = $event => ((fallbackToast.value.show) = $event)),
...
const AppPage = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-0645b610"]]);
