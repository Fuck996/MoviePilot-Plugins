...
const _hoisted_55 = { class: "mlk-section" };
const _hoisted_56 = {
  key: 0,
  class: "text-error"
};
const _hoisted_57 = { class: "mlk-section mlk-settings" };
const _hoisted_58 = { class: "mlk-settings-group" };
const _hoisted_59 = { class: "mlk-switch-grid" };
...
const _hoisted_64 = { class: "mlk-section-header" };
const _hoisted_65 = { class: "mlk-settings-group" };
const _hoisted_66 = { class: "mlk-switch-grid" };
const _hoisted_67 = { class: "mlk-settings-group" };
const _hoisted_68 = { class: "mlk-section-header" };
const _hoisted_69 = { class: "mlk-rule-title" };
const _hoisted_70 = { class: "mlk-rule-grid" };
const _hoisted_71 = { class: "mlk-settings-actions" };
const _hoisted_72 = { class: "mlk-detail-layout" };
const _hoisted_73 = { class: "mlk-detail-aside" };
const _hoisted_74 = { class: "mlk-detail-poster" };
const _hoisted_75 = {
  key: 1,
  class: "mlk-poster-fallback"
};
const _hoisted_76 = { class: "mlk-detail-aside-info" };
const _hoisted_77 = { class: "mlk-detail-aside-row" };
const _hoisted_78 = { class: "mlk-detail-aside-row" };
const _hoisted_79 = { class: "mlk-detail-aside-row" };
const _hoisted_80 = { class: "mlk-detail-aside-row" };
const _hoisted_81 = { class: "mlk-detail-aside-row" };
const _hoisted_82 = { class: "mlk-detail-content" };
const _hoisted_83 = { class: "mlk-detail-head" };
const _hoisted_84 = { class: "text-h6 font-weight-bold" };
const _hoisted_85 = { class: "text-body-2 text-medium-emphasis" };
const _hoisted_86 = { class: "mlk-chip-row" };
const _hoisted_87 = { class: "mlk-overview" };
const _hoisted_88 = { class: "mlk-detail-grid" };
const _hoisted_89 = { class: "text-caption text-medium-emphasis" };
const _hoisted_90 = { class: "mlk-detail-wide" };
const _hoisted_91 = {
  key: 0,
...
const _hoisted_94 = { class: "mlk-detail-actions" };
const _hoisted_95 = { class: "text-subtitle-2 mb-3" };
const _hoisted_96 = {
  key: 0,
  class: "mlk-target-list"
};
const _hoisted_97 = { class: "mlk-target-head" };
const _hoisted_98 = { class: "text-body-2" };
const _hoisted_99 = {
  key: 0,
  class: "text-caption text-medium-emphasis"
};
const _hoisted_100 = { class: "mlk-detail-summary mb-4" };
const _hoisted_101 = { class: "text-body-2 text-medium-emphasis mb-4" };
const _hoisted_102 = {
  key: 0,
  class: "mb-4"
};
const _hoisted_103 = { class: "mlk-chip-row" };
const _hoisted_104 = {
  key: 0,
  class: "text-caption text-medium-emphasis"
};
...
const _hoisted_106 = { class: "text-body-2" };
...
return (_ctx, _cache) => {
  ...
  return (_openBlock(), _createElementBlock("div", _hoisted_1, [
                    ...
                    default: _withCtx(() => [
                      _createElementVNode("div", null, [
                        _createElementVNode("div", _hoisted_45, [
                          _cache[49] || (_cache[49] = _createElementVNode("span", { class: "text-subtitle-1 font-weight-medium" }, "当前选择", -1)),
                  ...
                  _createVNode(_component_VExpandTransition, null, {
                    default: _withCtx(() => [
                      _withDirectives(_createVNode(_component_VSheet, {
                        ...
                        default: _withCtx(() => [
                          _cache[52] || (_cache[52] = _createElementVNode("div", { class: "mlk-section-header" }, [
                            _createElementVNode("div", null, [
                ...
                _createElementVNode("div", _hoisted_55, [
                  (cleanupQueueRows.value.length)
                    ? (_openBlock(), _createBlock(_component_VSheet, {
                        ...
                        default: _withCtx(() => [
                          _cache[55] || (_cache[55] = _createElementVNode("div", { class: "mlk-section-header" }, [
                            _createElementVNode("div", null, [
                ...
                { title: '详情', key: 'actions', width: 90, sortable: false },
                    ...
                    "item.seed_tasks": _withCtx(({ item }) => [
                      ...
                      (cleanupRecordStats(item).failedSeedTasks)
                        ? (_openBlock(), _createElementBlock("span", _hoisted_56, "/" + _toDisplayString(cleanupRecordStats(item).failedSeedTasks) + " 失败", 1))
                        : _createCommentVNode("", true)
                    ]),
                    "item.actions": _withCtx(({ item }) => [
                      _createVNode(_component_VBtn, {
              ...
              default: _withCtx(() => [
                _createElementVNode("div", _hoisted_57, [
                  _createElementVNode("div", _hoisted_58, [
                    _cache[56] || (_cache[56] = _createElementVNode("div", { class: "text-subtitle-1 font-weight-medium" }, "基础配置", -1)),
                  ...
                  _createElementVNode("div", _hoisted_61, [
                    _cache[58] || (_cache[58] = _createElementVNode("div", { class: "text-subtitle-1 font-weight-medium" }, "扫描与容量告警", -1)),
                  ...
                  _createElementVNode("div", _hoisted_65, [
                    _cache[62] || (_cache[62] = _createElementVNode("div", { class: "text-subtitle-1 font-weight-medium" }, "删除行为", -1)),
                  ...
                  _createElementVNode("div", _hoisted_67, [
                    ...
                    (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(configDraft.value.cleanup_rules, (rule, index) => {
                      return (_openBlock(), _createBlock(_component_VSheet, {
                        ...
                        default: _withCtx(() => [
                          _createElementVNode("div", _hoisted_69, "组合 " + _toDisplayString(index + 1), 1),
                    ...
                    _cache[65] || (_cache[65] = _createElementVNode("div", { class: "text-caption text-medium-emphasis" }, "数字条件填 0 表示不启用；每条组合至少启用一个条件才会生效。", -1))
                  ]),
    ...
    _createVNode(_component_VDialog, {
      ...
      "onUpdate:modelValue": _cache[29] || (_cache[29] = $event => ((detailDialog).value = $event)),
      "max-width": "920"
    }, {
      default: _withCtx(() => [
                ...
                _createElementVNode("div", _hoisted_72, [
                  _createElementVNode("div", _hoisted_73, [
                    ...
                    _createElementVNode("div", _hoisted_76, [
                      _cache[72] || (_cache[72] = _createElementVNode("div", { class: "text-subtitle-2 font-weight-medium" }, "媒体摘要", -1)),
                      _createElementVNode("div", _hoisted_77, [
                        _cache[68] || (_cache[68] = _createElementVNode("span", null, "观看状态", -1)),
                        _createElementVNode("strong", null, _toDisplayString(watchStateText(selectedMediaDetail.value)), 1)
                      ]),
                      _createElementVNode("div", _hoisted_78, [
                        _cache[69] || (_cache[69] = _createElementVNode("span", null, "媒体大小", -1)),
                        _createElementVNode("strong", null, _toDisplayString(_unref(formatBytes)(selectedMediaDetail.value.size)), 1)
                      ]),
                      _createElementVNode("div", _hoisted_79, [
                        _cache[70] || (_cache[70] = _createElementVNode("span", null, "所在盘", -1)),
                        _createElementVNode("strong", null, _toDisplayString(selectedMediaDetail.value.volume_name || '-'), 1)
                      ]),
                      _createElementVNode("div", _hoisted_80, [
                        _cache[71] || (_cache[71] = _createElementVNode("span", null, "卷剩余", -1)),
                  ...
                  _createElementVNode("div", _hoisted_82, [
                    _createElementVNode("div", _hoisted_83, [
                      _createElementVNode("div", null, [
                        _createElementVNode("div", _hoisted_84, _toDisplayString(selectedMediaDetail.value.title), 1),
                        _createElementVNode("div", _hoisted_85, _toDisplayString(selectedMediaDetail.value.year || '未知年份') + " · " + _toDisplayString(selectedMediaDetail.value.type_label) + " · " + _toDisplayString(selectedMediaDetail.value.library || selectedMediaDetail.value.server), 1)
                      ]),
                      _createVNode(_component_VBtn, {
                        icon: "mdi-close",
                        variant: "text",
                    ...
                    _createElementVNode("p", _hoisted_87, _toDisplayString(selectedMediaDetail.value.overview || '暂无简介。'), 1),
                    _createElementVNode("div", _hoisted_88, [
                      (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(selectedDetailInfoRows.value, (row) => {
                        return (_openBlock(), _createElementBlock("div", {
                          key: row.label
                        }, [
                          _createElementVNode("div", _hoisted_89, _toDisplayString(row.label), 1),
                          _createElementVNode("div", null, _toDisplayString(row.value), 1)
                        ]))
                      }), 128)),
                      _createElementVNode("div", _hoisted_90, [
                        _cache[73] || (_cache[73] = _createElementVNode("div", { class: "text-caption text-medium-emphasis" }, "路径", -1)),
                      ...
                      (selectedMediaDetail.value.emby_path_preview)
                        ? (_openBlock(), _createElementBlock("div", _hoisted_91, [
                            _cache[74] || (_cache[74] = _createElementVNode("div", { class: "text-caption text-medium-emphasis" }, "Emby 原路径", -1)),
                      ...
                      (selectedMediaDetail.value.genres?.length)
                        ? (_openBlock(), _createElementBlock("div", _hoisted_92, [
                            _cache[75] || (_cache[75] = _createElementVNode("div", { class: "text-caption text-medium-emphasis" }, "类型", -1)),
                    ...
                    _createElementVNode("div", _hoisted_94, [
                      _createVNode(_component_VSwitch, {
                        modelValue: deleteSource.value,
                        "onUpdate:modelValue": _cache[26] || (_cache[26] = $event => ((deleteSource).value = $event)),
                        color: "error",
                        "hide-details": "",
                        inset: "",
                        label: "同时删除源文件"
                      ...
                      _createVNode(_component_VBtn, {
                        ...
                        onClick: _cache[27] || (_cache[27] = $event => (toggleSelected(selectedMediaDetail.value)))
                      }, {
                        default: _withCtx(() => [
                      ...
                      _createVNode(_component_VBtn, {
                        ...
                        onClick: _cache[28] || (_cache[28] = $event => (createSinglePlan(selectedMediaDetail.value)))
                      }, {
    ...
    _createVNode(_component_VDialog, {
      ...
      "onUpdate:modelValue": _cache[31] || (_cache[31] = $event => ((planTargetDialog).value = $event)),
      "max-width": "820"
    }, {
      default: _withCtx(() => [
          ...
          ? (_openBlock(), _createBlock(_component_VCard, { key: 0 }, {
              default: _withCtx(() => [
                ...
                _createVNode(_component_VCardText, null, {
                  default: _withCtx(() => [
                    _createElementVNode("div", _hoisted_95, _toDisplayString(selectedPlanItem.value.title), 1),
                          ...
                          (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(selectedPlanItem.value.delete_targets, (target) => {
                            return (_openBlock(), _createBlock(_component_VSheet, {
                              ...
                              default: _withCtx(() => [
                                ...
                                _createElementVNode("div", _hoisted_98, _toDisplayString(target.path_preview || target.path), 1),
                                (target.directory_mapping)
                                  ? (_openBlock(), _createElementBlock("div", _hoisted_99, _toDisplayString(target.directory_mapping.name || '未命名目录配置') + " / " + _toDisplayString(target.directory_mapping.transfer_type || '未知整理方式'), 1))
                                  : _createCommentVNode("", true)
                              ]),
                              _: 2
                            }, 1024))
                ...
                _createVNode(_component_VCardActions, null, {
                  default: _withCtx(() => [
                    ...
                    _createVNode(_component_VBtn, {
                      variant: "text",
                      onClick: _cache[30] || (_cache[30] = $event => (planTargetDialog.value = false))
                    }, {
    ...
    _createVNode(_component_VDialog, {
      ...
      "onUpdate:modelValue": _cache[33] || (_cache[33] = $event => ((historyDetailDialog).value = $event)),
      "max-width": "980"
    }, {
      default: _withCtx(() => [
        (selectedHistoryItem.value)
          ? (_openBlock(), _createBlock(_component_VCard, { key: 0 }, {
              default: _withCtx(() => [
                ...
                _createVNode(_component_VCardText, null, {
                  default: _withCtx(() => [
                    ...
                    _createElementVNode("div", _hoisted_101, _toDisplayString(selectedHistoryItem.value.message), 1),
                    (selectedHistoryItem.value.items?.length)
                      ? (_openBlock(), _createElementBlock("div", _hoisted_102, [
                          _cache[81] || (_cache[81] = _createElementVNode("div", { class: "text-subtitle-2 mb-2" }, "本次媒体", -1)),
                      ...
                      : _createCommentVNode("", true),
                    _cache[83] || (_cache[83] = _createElementVNode("div", { class: "text-subtitle-2 mb-2" }, "删除文件", -1)),
                    _createVNode(_component_VDataTable, {
                      headers: [
              ...
              { title: '路径', key: 'path_preview' },
                    ...
                    _cache[84] || (_cache[84] = _createElementVNode("div", { class: "text-subtitle-2 mt-5 mb-2" }, "保种任务", -1)),
                    _createVNode(_component_VDataTable, {
                      headers: [
              ...
              { title: '结果', key: 'result', width: 110 },
                      ...
                      "item.downloader": _withCtx(({ item }) => [
                        ...
                        (item.original_downloader && item.original_downloader !== item.downloader)
                          ? (_openBlock(), _createElementBlock("div", _hoisted_104, " 原 " + _toDisplayString(item.original_downloader), 1))
                          : _createCommentVNode("", true)
                      ]),
                    ...
                    (selectedHistoryItem.value.failed_targets?.length)
                      ? (_openBlock(), _createElementBlock("div", _hoisted_105, [
                          _cache[82] || (_cache[82] = _createElementVNode("div", { class: "text-subtitle-2 mb-2" }, "失败项", -1)),
                          _createVNode(_component_VDataTable, {
                            headers: [
                { title: '类型', key: 'kind_label', width: 120 },
                { title: '路径', key: 'path_preview' },
                ...
                _createVNode(_component_VCardActions, null, {
                  default: _withCtx(() => [
                    ...
                    _createVNode(_component_VBtn, {
                      variant: "text",
                      onClick: _cache[32] || (_cache[32] = $event => (historyDetailDialog.value = false))
                    }, {
    ...
    _createVNode(_component_VDialog, {
      ...
      "onUpdate:modelValue": _cache[36] || (_cache[36] = $event => ((executeDialog).value = $event)),
      "max-width": "640"
    }, {
      default: _withCtx(() => [
        _createVNode(_component_VCard, null, {
          default: _withCtx(() => [
            ...
            _createVNode(_component_VCardText, null, {
              default: _withCtx(() => [
                _createElementVNode("div", _hoisted_106, " 本次计划将删除 " + _toDisplayString(pendingPlan.value?.ready_count || 0) + " 个已匹配媒体条目关联文件，预计释放 " + _toDisplayString(_unref(formatBytes)(pendingPlan.value?.estimated_reclaim_size)) + "。执行成功后会删除对应整理记录。 ", 1),
                (pendingPlan.value && (pendingPlan.value.ready_count || 0) < pendingPlanItems.value.length)
                  ? (_openBlock(), _createBlock(_component_VAlert, {
                      ...
                      default: _withCtx(() => [
                        _createTextVNode(" 批次中还有 " + _toDisplayString(pendingPlanItems.value.length - (pendingPlan.value.ready_count || 0)) + " 个未匹配条目，本次不会执行这些条目。 ", 1)
                      ]),
                      _: 1
                    }))
                  : _createCommentVNode("", true),
                ...
                _createVNode(_component_VCheckbox, {
                  ...
                  "onUpdate:modelValue": _cache[34] || (_cache[34] = $event => ((executeConfirmed).value = $event)),
                  color: "error",
            ...
            _createVNode(_component_VCardActions, null, {
              default: _withCtx(() => [
                ...
                _createVNode(_component_VBtn, {
                  variant: "text",
                  onClick: _cache[35] || (_cache[35] = $event => (executeDialog.value = false))
                }, {
    ...
    _createVNode(_component_VDialog, {
      ...
      "onUpdate:modelValue": _cache[39] || (_cache[39] = $event => ((deletePlanDialog).value = $event)),
      "max-width": "560"
    }, {
      default: _withCtx(() => [
        _createVNode(_component_VCard, null, {
          default: _withCtx(() => [
            ...
            _createVNode(_component_VCardText, null, {
              default: _withCtx(() => [
                _createElementVNode("div", _hoisted_107, " 将删除批次 " + _toDisplayString(pendingPlan.value?.batch_id || pendingPlan.value?.id) + " 的待处理记录，不会删除媒体文件、源文件或整理记录。 ", 1),
                _createVNode(_component_VCheckbox, {
                  modelValue: deletePlanConfirmed.value,
                  "onUpdate:modelValue": _cache[37] || (_cache[37] = $event => ((deletePlanConfirmed).value = $event)),
                  color: "error",
                  label: "我确认只删除当前批次记录",
                  "hide-details": "",
                  class: "mt-4"
            ...
            _createVNode(_component_VCardActions, null, {
              default: _withCtx(() => [
                ...
                _createVNode(_component_VBtn, {
                  variant: "text",
                  onClick: _cache[38] || (_cache[38] = $event => (deletePlanDialog.value = false))
                }, {
    ...
    _createVNode(_component_VSnackbar, {
      ...
      "onUpdate:modelValue": _cache[40] || (_cache[40] = $event => ((fallbackToast.value.show) = $event)),
