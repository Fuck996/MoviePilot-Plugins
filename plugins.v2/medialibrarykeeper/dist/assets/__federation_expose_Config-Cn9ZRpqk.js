...
import { _ as _export_sfc, t as toEditableConfig, a as toPayloadConfig } from './_plugin-vue_export-helper-DyMs-RuR.js';
...
return (_ctx, _cache) => {
  ...
  return (_openBlock(), _createElementBlock("div", _hoisted_1, [
    _createVNode(_component_VToolbar, {
      ...
      default: _withCtx(() => [
        _cache[11] || (_cache[11] = _createElementVNode("div", { class: "text-h6 ms-3" }, "媒体库管家配置", -1)),
    ...
    _createElementVNode("div", _hoisted_2, [
      ...
      _createElementVNode("div", _hoisted_3, [
        _createVNode(_component_VTextField, {
          ...
          "onUpdate:modelValue": _cache[5] || (_cache[5] = $event => ((config.value.disk_warning_free_gb) = $event)),
        ...
        _createVNode(_component_VTextField, {
          ...
          "onUpdate:modelValue": _cache[6] || (_cache[6] = $event => ((config.value.disk_warning_free_percent) = $event)),
          modelModifiers: { number: true },
          type: "number",
          label: "剩余比例阈值 %"
        }, null, 8, ["modelValue"]),
        _createVNode(_component_VTextField, {
          ...
          "onUpdate:modelValue": _cache[7] || (_cache[7] = $event => ((config.value.scan_cron) = $event)),
          label: "扫描周期 Cron"
        }, null, 8, ["modelValue"])
      ]),
      _createVNode(_component_VTextarea, {
        modelValue: config.value.library_names,
        "onUpdate:modelValue": _cache[8] || (_cache[8] = $event => ((config.value.library_names) = $event)),
        label: "限定媒体库名称",
      ...
      _createVNode(_component_VSwitch, {
        ...
        "onUpdate:modelValue": _cache[9] || (_cache[9] = $event => ((config.value.ai_suggestions) = $event)),
        color: "primary",
        inset: "",
      ...
      _createVNode(_component_VSwitch, {
        ...
        "onUpdate:modelValue": _cache[10] || (_cache[10] = $event => ((config.value.default_delete_source) = $event)),
        color: "error",
        inset: "",
        label: "默认同时删除源文件"
      }, null, 8, ["modelValue"])
...
const Config = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-42d602bf"]]);
