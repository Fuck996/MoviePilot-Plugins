...
const _hoisted_46 = { class: "mlk-plan-summary" };
const _hoisted_47 = { class: "mlk-plan-main" };
const _hoisted_48 = { class: "text-subtitle-1 font-weight-medium" };
const _hoisted_49 = { class: "text-caption text-medium-emphasis" };
const _hoisted_50 = { class: "text-body-2 text-medium-emphasis" };
const _hoisted_51 = { class: "mlk-chip-row" };
...
const _hoisted_72 = { class: "mlk-detail-aside" };
const _hoisted_73 = { class: "mlk-detail-poster" };
const _hoisted_74 = {
  key: 1,
  class: "mlk-poster-fallback"
};
const _hoisted_75 = { class: "mlk-detail-aside-info" };
const _hoisted_76 = { class: "mlk-detail-aside-row" };
...
const _hoisted_81 = { class: "mlk-detail-content" };
const _hoisted_82 = { class: "mlk-detail-head" };
const _hoisted_83 = { class: "text-h6 font-weight-bold" };
const _hoisted_84 = { class: "text-body-2 text-medium-emphasis" };
const _hoisted_85 = { class: "mlk-chip-row" };
const _hoisted_86 = { class: "mlk-overview" };
const _hoisted_87 = { class: "mlk-detail-grid" };
const _hoisted_88 = { class: "text-caption text-medium-emphasis" };
const _hoisted_89 = { class: "mlk-detail-wide" };
const _hoisted_90 = {
  key: 0,
...
const _hoisted_93 = { class: "mlk-detail-actions" };
const _hoisted_94 = { class: "text-subtitle-2 mb-3" };
const _hoisted_95 = {
  key: 0,
  class: "mlk-target-list"
};
const _hoisted_96 = { class: "mlk-target-head" };
const _hoisted_97 = { class: "text-body-2" };
const _hoisted_98 = {
  key: 0,
  class: "text-caption text-medium-emphasis"
};
const _hoisted_99 = { class: "mlk-detail-summary mb-4" };
const _hoisted_100 = { class: "text-body-2 text-medium-emphasis mb-4" };
const _hoisted_101 = {
  key: 0,
  class: "mb-4"
};
              ...
              default: _withCtx(() => [
                _createElementVNode("div", _hoisted_44, [
                  _createVNode(_component_VSheet, {
                    ...
                    default: _withCtx(() => [
                      _createElementVNode("div", null, [
                        _cache[49] || (_cache[49] = _createElementVNode("div", { class: "text-subtitle-1 font-weight-medium" }, "当前选择", -1)),
                      ...
                      _createVNode(_component_VSwitch, {
                        ...
                        "onUpdate:modelValue": _cache[8] || (_cache[8] = $event => ((deleteSource).value = $event)),
                        color: "error",
                        "hide-details": "",
                        inset: "",
                        label: "同时删除源文件"
                      ...
                      _createVNode(_component_VTooltip, {
                        ...
                        activator: _withCtx(({ props: tooltipProps }) => [
                          _createVNode(_component_VBtn, _mergeProps(tooltipProps, {
                            ...
                            onClick: _cache[9] || (_cache[9] = $event => (selectedPlanExpanded.value = !selectedPlanExpanded.value))
                        ...
                        default: _withCtx(() => [
                          _createElementVNode("div", _hoisted_46, [
                            _createElementVNode("div", _hoisted_47, [
                              _createElementVNode("div", _hoisted_48, "批次 " + _toDisplayString(pendingPlan.value.batch_id || pendingPlan.value.id), 1),
                              _createElementVNode("div", _hoisted_49, _toDisplayString(pendingPlan.value.source_label || '手动选择') + " · " + _toDisplayString(pendingPlan.value.created_at), 1),
                              _createElementVNode("div", _hoisted_50, _toDisplayString(pendingPlan.value.message), 1),
                ...
                _createElementVNode("div", _hoisted_71, [
                  ...
                  _createElementVNode("div", _hoisted_81, [
                    _createElementVNode("div", _hoisted_82, [
                      _createElementVNode("div", null, [
                        _createElementVNode("div", _hoisted_83, _toDisplayString(selectedMediaDetail.value.title), 1),
                        _createElementVNode("div", _hoisted_84, _toDisplayString(selectedMediaDetail.value.year || '未知年份') + " · " + _toDisplayString(selectedMediaDetail.value.type_label) + " · " + _toDisplayString(selectedMediaDetail.value.library || selectedMediaDetail.value.server), 1)
                      ]),
                      _createVNode(_component_VBtn, {
                        icon: "mdi-close",
                        variant: "text",
                    ...
                    _createElementVNode("p", _hoisted_86, _toDisplayString(selectedMediaDetail.value.overview || '暂无简介。'), 1),
                    _createElementVNode("div", _hoisted_87, [
                      (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(selectedDetailInfoRows.value, (row) => {
                        return (_openBlock(), _createElementBlock("div", {
                          key: row.label
                        }, [
                          _createElementVNode("div", _hoisted_88, _toDisplayString(row.label), 1),
          ...
          ? (_openBlock(), _createBlock(_component_VCard, { key: 0 }, {
              default: _withCtx(() => [
                ...
                _createVNode(_component_VCardText, null, {
                  default: _withCtx(() => [
                    _createElementVNode("div", _hoisted_94, _toDisplayString(selectedPlanItem.value.title), 1),
                          ...
                          (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(selectedPlanItem.value.delete_targets, (target) => {
                            return (_openBlock(), _createBlock(_component_VSheet, {
                              ...
                              default: _withCtx(() => [
                                ...
                                _createElementVNode("div", _hoisted_97, _toDisplayString(target.path_preview || target.path), 1),
                                (target.directory_mapping)
                                  ? (_openBlock(), _createElementBlock("div", _hoisted_98, _toDisplayString(target.directory_mapping.name || '未命名目录配置') + " / " + _toDisplayString(target.directory_mapping.transfer_type || '未知整理方式'), 1))
                                  : _createCommentVNode("", true)
                              ]),
                              _: 2
                            }, 1024))
              ...
              default: _withCtx(() => [
                ...
                _createVNode(_component_VCardText, null, {
                  default: _withCtx(() => [
                    ...
                    _createElementVNode("div", _hoisted_100, _toDisplayString(selectedHistoryItem.value.message), 1),
              ...
              { title: '结果', key: 'result', width: 110 },
                      ...
                      "item.downloader": _withCtx(({ item }) => [
                        ...
                        (item.original_downloader && item.original_downloader !== item.downloader)
                          ? (_openBlock(), _createElementBlock("div", _hoisted_103, " 原 " + _toDisplayString(item.original_downloader), 1))
                          : _createCommentVNode("", true)
                      ]),
      ...
      default: _withCtx(() => [
        _createVNode(_component_VCard, null, {
          default: _withCtx(() => [
            ...
            _createVNode(_component_VCardText, null, {
              default: _withCtx(() => [
                _createElementVNode("div", _hoisted_105, " 本次计划将删除 " + _toDisplayString(pendingPlan.value?.ready_count || 0) + " 个已匹配媒体条目关联文件，预计释放 " + _toDisplayString(_unref(formatBytes)(pendingPlan.value?.estimated_reclaim_size)) + "。执行成功后会删除对应整理记录。 ", 1),
      ...
      default: _withCtx(() => [
        _createVNode(_component_VCard, null, {
          default: _withCtx(() => [
            ...
            _createVNode(_component_VCardText, null, {
              default: _withCtx(() => [
                _createElementVNode("div", _hoisted_106, " 将删除批次 " + _toDisplayString(pendingPlan.value?.batch_id || pendingPlan.value?.id) + " 的待处理记录，不会删除媒体文件、源文件或整理记录。 ", 1),
                _createVNode(_component_VCheckbox, {
...
const AppPage = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-08fd0a69"]]);
